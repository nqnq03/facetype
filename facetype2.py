...
# 学習済みモデルをロードする
model = load_model("C:\\Users\\na-09\\2022\\webapp2022\\opencv_work\\facetype\\model_stlight.h5")
model_2 = load_model("C:\\Users\\na-09\\2022\\webapp2022\\opencv_work\\facetype\\model_adlut.h5")
        ...
        if request.method == 'POST': #リクエストがポストかどうかの判別
            ...
            if file and allowed_file(file.filename):#ファイルのチェック
                ...
                # 顔認識出来た場合
                    ...
                    pred_answer = classes[predicted] +"&" + classes2[predicted_2] + "タイプです"
